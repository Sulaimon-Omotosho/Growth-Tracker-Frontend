  ...
  return (
    <section className='pb-10'>
      <section className='w-full h-120 overflow-hidden relative'>
        ...
        <div className='bg-[url("/assets/cell.jpg")] bg-cover bg-center bg-no-repeat absolute inset-0' />
        <div className='absolute inset-0 bg-linear-to-t from-black/80 via-black/40 to-transparent' />

        <div className='relative z-5 h-full flex flex-col justify-end text-white text-center px-6 pb-16'>
          <h1 className='text-4xl font-bold'>Other Courses</h1>
          <p className='font-semibold text-lg'>
            Grow in the church with these other classes and leadership courses.
          </p>
        </div>
      </section>
      {/* DESCRIPTION */}
      <section className='max-w-3xl mx-auto px-4 py-12'>
        <h1 className='text-3xl font-bold text-center mb-4'>Other Courses</h1>
